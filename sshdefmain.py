...
#pdb.set_trace()
class sshclient:
    def __init__(self,hostname,port,password,key_filename):
    ...
    self.connect(hostname=hostname,port=port , username=username, password=password,key_filename=key_filename)
